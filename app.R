                 ...
                 tabPanel('Explore water rights', value='tab2',
                          sidebarLayout(
                            sidebarPanel(id='tab1Controls',
                                         ...
                                         'and potential transfers within the Upper Gunnison River Basin. For background, methods, and case studies, see ',
                                         'Andrew Hamilton\'s Duke University ',
                                         a("Masters Project",     href="http://dukespace.lib.duke.edu/dspace/handle/10161/14171", target='_blank'),'.',br(),br(), 
